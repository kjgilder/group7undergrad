...
void group7undergrad_step(void)
{
  ...
  if (group7undergrad_B.EnabledSubsystem.In1.Data <= 10.0) {
    /* BusAssignment: '<Root>/Bus Assignment' */
    rtb_BusAssignment.Data = (rtb_Switch -
      group7undergrad_B.EnabledSubsystem_d.In1.Data) * -0.25;
  } else if ((group7undergrad_DW.stop_light_distance <= 100.0) && (25.0 -
