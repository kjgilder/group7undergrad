...
//
// Code generated for Simulink model 'dm_ros_controller2'.
//
// Model version                  : 1.5
// Simulink Coder version         : 24.1 (R2024a) 19-Nov-2023
// C/C++ source code generated on : Fri Nov 15 19:46:35 2024
//
  ...
  namespace matlab
  {
    ...
    void NodeInterface::initialize(int argc, char ** argv)
    {
      try {
        ...
        ROS_INFO("** Starting the model \"dm_ros_controller2\" **\n");

        // initialize the model which will initialize the publishers and subscribers
        rtmSetErrorStatus(dm_ros_controller2_M, (NULL));
        dm_ros_controller2_initialize();
    ...
    boolean_T NodeInterface::getStopRequestedFlag(void)
    {
      ...
      return (!(rtmGetErrorStatus(dm_ros_controller2_M)
                == (NULL)));

#else

      return (!(rtmGetErrorStatus(dm_ros_controller2_M)
                == (NULL)) || rtmGetStopRequested(dm_ros_controller2_M));
    ...
    {
      mRunModel = (rtmGetErrorStatus(dm_ros_controller2_M) ==
                   (NULL));
      while (mRunModel) {
        mBaseRateSem.wait();
